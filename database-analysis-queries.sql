...
-- =============================================================================
-- 8. TODAY'S PERFORMANCE (using todays_trades view)
-- =============================================================================
SELECT 
    ...
    ROUND((COUNT(CASE WHEN is_winner = true THEN 1 END)::decimal / COUNT(*)) * 100, 2) as win_rate_percent,
    SUM(pnl_usd) as total_pnl_usd,
    AVG(pnl_usd) as avg_pnl_usd
FROM todays_trades;

-- =============================================================================
-- 9. ASSET CLASS DISTRIBUTION
-- =============================================================================
SELECT 
    ...
    COUNT(CASE WHEN is_winner = true THEN 1 END) as winning_trades,
    ROUND((COUNT(CASE WHEN is_winner = true THEN 1 END)::decimal / COUNT(*)) * 100, 2) as win_rate
FROM trades 
GROUP BY asset_class 
ORDER BY trade_count DESC;

-- =============================================================================
-- 10. EXCHANGE DISTRIBUTION
-- =============================================================================
SELECT 
