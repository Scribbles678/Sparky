...
### CCXT Exchanges (Binance, Coinbase, Apex, etc.)
For CCXT-supported exchanges, use the exchange name as the `exchange` field:
```json
{
  "secret": "Sparky_Bot_Secret_XYZ123",
  "exchange": "binance",
...
See [CCXT documentation](https://docs.ccxt.com/) for supported exchanges and symbol formats.
